...
def print_config(config):
    ...
    print("="*50)
    print(f"Left JP2: {config['left_jp2']}")
    print(f"Right JP2: {config['right_jp2']}")
    ...
    print(f"UTM Zone: {config['utm_zone']}")
...
def main():
    ...
    try:
        ...
        # Step 0: Convert JP2 to TIFF if necessary
    
        print("\n0. Converting JP2 files to TIFF...")
        convert_jp2_to_tif(
            config['left_jp2'],
            config['right_jp2'],                 
            config['left_img'], 
        ...
        print("JP2 to TIFF conversion completed.")
